<script>
  ...
  { num: '2',  label: 'The Tally',       icon: '▤', color: '#7a4a10' },
  { num: '3',  label: 'Build Free',      icon: '⌂', color: '#2a3a5e' },
  { num: '4',  label: 'Living Engine',   icon: '◎', color: '#5e1a1a' },
  { num: '5',  label: 'Living Soil',     icon: '✦', color: '#3a4a1a' },
  { num: '6',  label: 'The Clean Table', icon: '♆', color: '#6a3a0a' },
  { num: '7',  label: 'Sacred Water',    icon: '◈', color: '#2a4a6e' },
  { num: '8',  label: 'Blue Sky',        icon: '✺', color: '#1a3a5e' },
  { num: '9',  label: 'The Living Body', icon: '♁', color: '#3a1a5e' },
  { num: '10', label: 'Open Archive',    icon: '◫', color: '#1a4a3a' },
  { num: '11', label: 'Living Teaching', icon: '⚇', color: '#6a5a10' },
  { num: '12', label: 'Free Land',       icon: '⌂', color: '#3a2a0a' },
...
<section class="goals">
  <div class="goals-inner">
    <div class="goals-title">Living Way Goals — Free Assembly of Living Souls</div>
    <div class="goals-grid">
      ...
      <div class="tile t3">
        ...
        <div class="tile-label">Build Free</div>
      </div>
      ...
      <div class="tile t9">
        ...
        <div class="tile-icon"><svg viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="19" cy="9" r="3.5" fill="none" stroke="#D0A0F0" stroke-width="1.5"/><circle cx="25" cy="14" r="2.5" fill="none" stroke="#D0A0F0" stroke-width="1.5"/><line x1="19" y1="13" x2="19" y2="24" stroke="#D0A0F0" stroke-width="1.5" stroke-linecap="round"/><line x1="14" y1="18" x2="24" y2="18" stroke="#D0A0F0" stroke-width="1.3" stroke-linecap="round"/><line x1="19" y1="24" x2="15" y2="31" stroke="#D0A0F0" stroke-width="1.5" stroke-linecap="round"/><line x1="19" y1="24" x2="23" y2="31" stroke="#D0A0F0" stroke-width="1.5" stroke-linecap="round"/></svg></div>
      ...
      <div class="tile t12">
        ...
        <div class="tile-label">Free Land</div>
      </div>
