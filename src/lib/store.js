...
function getSamples() {
  return [
    {
      id: "1",
      title: "Introduction to Conspirators Ierarchy",
      author: "Dr. John Coleman",
      category: "books",
      description: "THE STORY OF THE COMMITTEE OF 300",
      size: "851 KB",
      pages: 169,
      date: "2024-11-15",
      tags: ["globalism", "new-world-order"],
      fileName: "CONSPIRATORS HIERARCHY_ THE STORY OF THE COMMITTEE OF 300.pdf",
      fileData: null,
    },
    {
      id: "2",
      title: "The Mutus Liber",
      author: "Anonymous (1677)",
      category: "books",
      description:
        "The silent book — alchemical emblems without words. A visual treatise on the Great Work.",
      size: "18.7 MB",
      pages: 21,
      date: "2024-10-03",
      tags: ["alchemy", "hermetic", "esoteric"],
      fileName: "mutus-liber.pdf",
      fileData: null,
    },
    {
...
export const goals = [
  {
    id: "1",
    title:
      "Living souls meeting directly — in exchange, in word, in building, in growing",
    color: "#b8860b",
    gradient:
      "linear-gradient(135deg, #0f7a5a 0%, #c8a000 45%, #ffd700 70%, #986e24 100%)",
    textColor: "#fff8dc",
    summary: "No one between Me and God",
    description:
      "A living soul stands in direct relation to God and to all of creation. This has always been so. The living way begins from this recognition — that every exchange, every word, every act of a living soul flows directly from that standing. When two living souls meet to interchange, to speak, to build or to grow together, the meeting is whole in itself. It requires no witness, no record-keeper, no approving from outside. The living way calls solvens to build all their structures — their tallies, their circles, their bonds — on this foundation. The direct meeting of souls is the most natural thing in the world. We are simply remembering how to live it.",
    docs: [],
  },

  {
    id: "2",
    title:
      "Full sovereignty over your own living body. Complete confidence arises when accepting responsibility for your own well-being.",
    color: "#5a1a7a",
    gradient: "linear-gradient(135deg, #32085a 0%, #5a1a7a 50%, #9030c0 100%)",
    textColor: "#e8c0ff",
    summary:
      "The living body is perfect. Its well-being is the living soul's own knowing and choosing.",
    description:
...

  {
    id: "4",
    title:
      "Having a home is a default. Take it back. No need to ask. No need to wait.",
    color: "#1a3a8a",
    gradient: "linear-gradient(135deg, #0d1f5c 0%, #1a3a8a 50%, #3a6ae8 100%)",
    textColor: "#c0d8ff",
    summary: "The knowledge to raise a roof belongs to all.",
    description:
      "To build is one of the most fundamental acts of a living soul. A dwelling, a workshop, a barn, a path — these are extensions of the body into the world. Shelter Reclaimed affirms that no institution may prohibit the construction of shelter, tools, or infrastructure needed for dignified life. Codes, permits, and restrictions that exist to extract or enforce dependency rather than protect genuine safety are not binding on living souls. Every soul has the right to shape their dwelling and their land according to their knowing, their needs, and their solven's accord.",
    docs: [],
  },

  {
    id: "5",
    title:
      "Effective Engine — any fuel, no poison. The knowledge that was buried, recovered.",
    color: "#8a1a1a",
    gradient: "linear-gradient(135deg, #5c0a0a 0%, #a02020 50%, #e04040 100%)",
    textColor: "#ffd0d0",
    summary: "Energy and productive power openly available to all solvens.",
    description:
      "The engine of life is energy — the capacity to do work, to move, to transform. When energy is monopolised, everything downstream is controlled. Living Engine affirms that solvens must have access to the means of generating, storing, and distributing power: mechanical, electrical, thermal, and biological. This includes the right to build mills, collect water, harness wind, ferment fuel, and maintain engines without dependency on centralised suppliers. Numerous engine designs capable of operating on variable local fuels — running clean — exist in historical archives and were buried by commercial and political opposition. Recovering them is the work.",
    docs: [],
  },

  {
    id: "6",
    title:
      "Electroculture and permaculture — suppressed knowledge, recovered. No poison on the land.",
    color: "#2d6010",
    gradient: "linear-gradient(135deg, #1a3a08 0%, #2d6010 50%, #4a9a18 100%)",
    textColor: "#c8f080",
...

  {
    id: "10",
    title:
      "All knowing placed openly where any soul can reach it. What was buried belongs to all.",
    color: "#0f5a38",
    gradient: "linear-gradient(135deg, #083020 0%, #0f5a38 50%, #18a060 100%)",
    textColor: "#a0f0c8",
    summary: "Living knowing kept open, passed on, accessible to all.",
    description:
      "Knowing that is locked away serves only its keeper. Open Archive affirms that the accumulated learning of living souls — books, techniques, maps, histories, sciences, arts — belongs to everyone and must be kept, copied, and distributed without restriction. This goal covers open archives, open learning records, the recovery of rare texts, oral tradition preservation, and the right to learn without paying tribute to gatekeepers of knowing. This archive is one expression of that goal.",
    docs: [],
  },

  {
    id: "11",
    title:
      "Living wisdom passed hand to hand, elder to youth. Teaching outside all institutions.",
    color: "#7a5200",
    gradient: "linear-gradient(135deg, #4a2e00 0%, #7a5200 50%, #c08010 100%)",
    textColor: "#ffe0a0",
    summary:
      "Living knowing passed directly between souls, outside institutions.",
    description:
      "True teaching is not the transfer of certified information from an accredited institution. It is the living transmission of understanding from one soul to another — from elder to youth, from craftsperson to apprentice, from grower to child. Living Teaching affirms the right to teach and to learn outside institutional systems, to learn through doing, and to pass on knowing through direct bond. Credentials that gate-keep rather than verify are obstacles to living teaching, not expressions of it. The elder's hand on the young one's shoulder. That is school.",
    docs: [],
  },

  {
    id: "12",
    title: "Every soul stands on enough land to grow and build.",
    color: "#4a3000",
    gradient: "linear-gradient(135deg, #2a1500 0%, #4a3000 50%, #8a5818 100%)",
    textColor: "#f0c878",
    summary: "Land access as the foundation of living, self-sustaining life.",
    description:
      "Land is not created by its claimants. It exists before any title, any fence, any deed. Open Land affirms that every soul and every solven must have access to enough land to grow food, build shelter, and sustain life. No system of land holding may leave the majority landless while a few hold vast territories idle or extractive. Solvens have the right to occupy, cultivate, and tend land that sustains them, regardless of paper claims made by distant entities who have never walked it.",
    docs: [],
  },
