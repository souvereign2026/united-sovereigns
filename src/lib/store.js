...
export const goals = [
  ...
  { id: '14', title: 'Locating living traditions that never broke. Bringing the knowledge back.', color: '#5a3000', gradient: 'linear-gradient(135deg, #301800 0%, #5a3000 50%, #a05810 100%)', textColor: '#f0c880', summary: 'Seeking out the oldest living traditions and learning from them directly.', description: 'Indigenous and traditional solvens are not repositories of quaint customs. They are living kindreds that maintained sophisticated, stable bonds with the living world for spans that dwarf the entire duration of industrial life. The knowing they carry — of soil, water, plant, creature, weather and living circle — is irreplaceable and is being lost. Elder Bond affirms the obligation of newer solvens to seek out what was never lost, to approach as students, not teachers, and to receive what older traditions kept through everything that tried to extinguish it.', docs: [] },

  { id: '15', title: 'Documenting what works. Giving it openly. Letting the living way speak for itself.', color: '#1a1a6a', gradient: 'linear-gradient(135deg, #0a0a3a 0%, #1a1a6a 50%, #3030b8 100%)', textColor: '#c0c0ff', summary: 'The living way growing through example, open invitation, and open giving.', description: 'No living way spreads by force. It spreads because those who live it demonstrate that it works — that it produces flourishing, dignity, and genuine living. The Way Spreads affirms that the expansion of these principles must happen through example, open invitation, and the open giving of knowing, tools, and experience. Solvens that embody these goals become beacons. They do not conquer or convert — they demonstrate. Those who see and recognise the truth of what they see are welcome to join, to learn, and to begin their own expression of the living way.', docs: [] },
